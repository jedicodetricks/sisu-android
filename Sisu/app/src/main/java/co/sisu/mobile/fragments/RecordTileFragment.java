...
public class RecordTileFragment extends Fragment implements View.OnClickListener, AsyncServerEventListener, PopupMenu.OnMenuItemClickListener, SearchView.OnQueryTextListener, ClientMessagingEvent {
...
//        });
    ...
    private View createFullView(ViewGroup container, JSONObject tileTemplate) {
        ...
        View parentLayout = inflater.inflate(R.layout.activity_record_template_parentlayout, container, false);
